...
const Footer = () => {
  return (
    <footer className="czjaw overflow-hidden">
      <div className="czd2q c92f3 cmhb9 c1plj">
        <div className="cq8p6 cvde3 c5dtj cnqgv cxer1 cxbax">
          {/*-- Footer illustration --*/}
          <div className="cey85 codcr" aria-hidden="true">
            <svg
              className="ck61j cimtg cgdju cgk3d c35ck cp8ye cpxo3"
              width="800"
              height="264"
              fill="none"
          ...
          {/*-- Top area: Blocks --*/}
          <div className="ckv2s c8zhu cfsms cn59p cy5hl c74as">
            {/*-- 1st block --*/}
            <div className="cnumf cdeew">
              {/*-- Logo --*/}
              <a className="caun5" href="index.html" aria-label="Cruip">
                <svg
            ...
            <div className="cmf5j cufz0 cf0hp cv9a4 cn59p c74as">
              {data.map((item) => (
                <div className="ceng1" key={item.id}>
                  <h6 className="cf4hw cwaxc csrqa">{item.title}</h6>
                  <ul>
                    {item.listItem.map((list) => (
                      <li className="ccipq">
                        <a
                          className="text-gray-600 c0atf csz0f clq5w ccb29 ceo83"
                          href="#0"
                        >
                          {list}
                        </a>
          ...
          {/*-- Bottom area --*/}
          <div className="cfofo cxv2k ci5ce">
            {/*-- Social links --*/}
            <ul className="ch3bl c4u1v cz36d cyb9k cnc7y">
              <li>
                <a
                  className="text-white bg-teal-500 cvvk7 capfz cj3dx csz0f cw3my cxdxt cpz4m clq5w ccb29 ceo83 cnc7y"
                  href="#0"
                  aria-label="Twitter"
                >
                  <svg
                    className="c4u31 csz25 cchtt"
                    viewBox="0 0 32 32"
                    xmlns="http://www.w3.org/2000/svg"
                  >
            ...
            {/*-- Copyrights note --*/}
            <div className="text-gray-600 c0atf ceng1 c3kuf">
